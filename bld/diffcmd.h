...
int historical_version_of_file(const char *revision,const char *file,Blob *content,int *pIsLink,int *pIsExe,int *pIsBin,int errCode);
#include <dirent.h>
...
void diff_file(Blob *pFile1,int isBin1,const char *zFile2,const char *zName,const char *zDiffCmd,const char *zBinGlob,int fIncludeBinary,u64 diffFlags);
