...
void style_submenu_multichoice(const char *zName,int nChoice,const char **azChoice,int isDisabled);
void style_submenu_binary(const char *zName,const char *zTrue,const char *zFalse,int isDisabled);
...
extern int nFormAction;
extern char **aFormAction;
extern int nHrefAlloc;
extern int nHref;
extern char **aHref;
