#line 1 "../fossil-1.32/src/captcha.c"
/*
...
void captcha_generate(int showButton){
  ...
  cgi_printf("<div class=\"captcha\"><table class=\"captcha\"><tr><td><pre>\n"
         "%h\n"
         "</pre>\n"
...
int exclude_spiders(const char *zPage){
  ...
  cgi_printf("<p>Please demonstrate that you are human, not a spider or robot</p>\n");
  captcha_generate(1);
  cgi_printf("</form>\n");
  style_footer();
  return 1;
