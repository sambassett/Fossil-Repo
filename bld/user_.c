...
void access_log_page(void){
  ...
  cgi_printf("<center><table border=\"1\" cellpadding=\"5\" id='logtable'>\n"
  ...
  cgi_printf("</tbody></table></center>\n");
  db_finalize(&q);
  cgi_printf("<hr>\n"
         "<form method=\"post\" action=\"%s/access_log\">\n"
