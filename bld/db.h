...
void db_initial_setup(const char *zTemplate,const char *zInitialDate,const char *zDefaultUser,int makeServerCodes);
...
void db_open_or_attach(const char *zDbName,const char *zLabel,int *pWasAttached);
